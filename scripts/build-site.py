...
COPY = {
    'zh': {
        ...
        'features': [
            ('01', '看懂使用节奏', '选择全天或工作时段算法。可设工作日、上下班与休息时间；应剩在下班后暂停下降，显示使用快慢、耗尽预测和今日建议。'),
    ...
    'en': {
        ...
        'features': [
            ('01', 'Understand your pace', 'Choose all-day or working-hours pacing, with weekdays, shifts and breaks. Target remaining freezes off duty; see pace, exhaustion estimates and today’s budget.'),
